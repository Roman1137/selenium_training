...
namespace selenium_training._09_RemoteLaunch
{
    class SeleniumGridExtras
    {
        ...
        //зайти браузером и посмотреть его текущее состояние. ответ - значение по умолчанию 3000.
        ...
        //либо все удалить и пройти через это "интервью".
        //1. 1(node)
        //2. укажем 3001 т.к 3000 уже занят
        ...
        //Есть ещё одна консоль, которая работает на порту 3000 http://192.168.0.102:3000 - это консоль Selenium Grid Extras. Там можно увидеть скриншот не окна браузера,
        ...
        //И кроме этого есть консоль http://192.168.0.102:3001, которая позволяет посмотреть значение системных свойств и скриншот машины НА КОТОРОЙ РАБОТАЕТ УЗЕЛ на уровне Операционной системы.
